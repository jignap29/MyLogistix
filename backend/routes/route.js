...
const { noticeCreate, noticeList, deleteNotices, deleteNotice, updateNotice, noticeWithTokens , noticeWithTokenByPhone} = require('../controllers/notice-controller.js');
const {planCreate, planList, updatePlan, deletePlan, deletePlans} = require('../controllers/plan-controller.js')
const {
    studentRegister,
    studentLogIn,
    getStudents,
...
router.get('/PlanList/:id', planList);
