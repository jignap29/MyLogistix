...
// import { MenuItem, TextField, Pagination } from '@mui/material';
...
//     const cloned = { ...company };
//     if (cloned.shippingPlan && typeof cloned.shippingPlan === 'object') {
//       cloned.shippingPlan = cloned.shippingPlan._id;
//     }
//     setEditCompany(company);
//     setEditedValues(cloned);
//     setFormErrors({});
//   };
...
//     if (file) {
//       setEditedValues((prev) => ({ ...prev, [fieldName]: file }));
...
//       {/* All dialogs remain unchanged and are already responsive due to MUI */}
...
import CloseIcon from '@mui/icons-material/Close';
import styled from 'styled-components';
import { getAllPlans } from '../../../redux/planRelated/planHandle'; // ✅ your actual path
...
const ShowCourierCompanies = () => {
  ...
  useEffect(() => {
    dispatch(getAllCourierCompanies());
    dispatch(getAllWallets()); // ✅ to get all balances
  }, [dispatch]);
  ...
  return (
    <Wrapper>
      ...
      {/* Your View and Edit Dialogs Stay Unchanged Here... */}
            ...
            <>
              ...
              <Grid container spacing={2}>
                {[
                  ...
                  // Handle URL if missing or invalid
